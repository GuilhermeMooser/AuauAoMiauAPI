...
export class CreateTableStateUf1757875707370 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      INSERT INTO state_uf (id, name, uf, ibge, country, ddd) VALUES
      (1, 'Acre', 'AC', 12, 1, '68'),
    ...
    await queryRunner.query(`
      COMMENT ON TABLE state_uf IS 'Federative Units';
    `);
  }
